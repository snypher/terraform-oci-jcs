...
resource "oci_core_subnet" "nw_sn_data" {
  ...
  security_list_ids = ["${oci_core_security_list.nw_sl_data.id}"]
  vcn_id = "${oci_core_vcn.nw_vcn.id}"
  dhcp_options_id = "${oci_core_dhcp_options.nw_dhcp_opt.id}"
...
resource "oci_core_subnet" "nw_sn_app" {
  ...
  compartment_id = "${var.compartment_ocid}"
  security_list_ids = ["${oci_core_security_list.nw_sl_app.id}"]
  vcn_id = "${oci_core_vcn.nw_vcn.id}"
  dhcp_options_id = "${oci_core_dhcp_options.nw_dhcp_opt.id}"
...
resource "oci_core_subnet" "nw_sn_lbaas" {
  ...
  compartment_id = "${var.compartment_ocid}"
  security_list_ids = ["${oci_core_security_list.nw_sl_lbaas.id}"]
  vcn_id = "${oci_core_vcn.nw_vcn.id}"
  dhcp_options_id = "${oci_core_dhcp_options.nw_dhcp_opt.id}"
  ...
  route_table_id = "${oci_core_route_table.nw_rt_public.id}"
}
...
resource "oci_core_subnet" "nw_sn_admin" {
  ...
  compartment_id = "${var.compartment_ocid}"
  security_list_ids = ["${oci_core_security_list.nw_sl_admin.id}"]
  vcn_id = "${oci_core_vcn.nw_vcn.id}"
  dhcp_options_id = "${oci_core_dhcp_options.nw_dhcp_opt.id}"
